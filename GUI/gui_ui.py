...
"border-right:1 solid #868e96;")
        ...
        self.sys_stackedWidget.setGeometry(QRect(0, 0, 270, 291))
        font1 = QFont()
...
"color: rgb(0, 0, 0);")
        ...
        self.exp1_ele1x_lineEdit = QLineEdit(self.page_3)
        self.exp1_ele1x_lineEdit.setObjectName(u"exp1_ele1x_lineEdit")
        self.exp1_ele1x_lineEdit.setGeometry(QRect(20, 110, 135, 30))
        font4 = QFont()
        font4.setFamilies([u"Arial"])
        font4.setBold(True)
        self.exp1_ele1x_lineEdit.setFont(font4)
        self.exp1_ele1x_lineEdit.setStyleSheet(u"border: 1px solid white;\n"
"border-radius: 5px;\n"
"background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.exp1_ele1y_lineEdit = QLineEdit(self.page_3)
        self.exp1_ele1y_lineEdit.setObjectName(u"exp1_ele1y_lineEdit")
        self.exp1_ele1y_lineEdit.setGeometry(QRect(20, 160, 135, 30))
        self.exp1_ele1y_lineEdit.setFont(font4)
        self.exp1_ele1y_lineEdit.setStyleSheet(u"border: 1px solid white;\n"
"border-radius: 5px;\n"
"background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.exp1_ele1z_lineEdit = QLineEdit(self.page_3)
        self.exp1_ele1z_lineEdit.setObjectName(u"exp1_ele1z_lineEdit")
        self.exp1_ele1z_lineEdit.setGeometry(QRect(20, 210, 135, 30))
        self.exp1_ele1z_lineEdit.setFont(font4)
...
"color: rgb(0, 0, 0);")
        ...
        self.line_2.setGeometry(QRect(5, 15, 5, 271))
...
"border-color: rgb(233, 236, 239);")
        ...
        self.exp2_ele1x_lineEdit = QLineEdit(self.page_4)
        self.exp2_ele1x_lineEdit.setObjectName(u"exp2_ele1x_lineEdit")
        self.exp2_ele1x_lineEdit.setGeometry(QRect(20, 110, 65, 30))
        self.exp2_ele1x_lineEdit.setFont(font4)
        self.exp2_ele1x_lineEdit.setStyleSheet(u"border: 1px solid white;\n"
"border-radius: 5px;\n"
"background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.exp2_ele2x_lineEdit = QLineEdit(self.page_4)
        self.exp2_ele2x_lineEdit.setObjectName(u"exp2_ele2x_lineEdit")
        self.exp2_ele2x_lineEdit.setGeometry(QRect(90, 110, 65, 30))
        self.exp2_ele2x_lineEdit.setFont(font4)
        self.exp2_ele2x_lineEdit.setStyleSheet(u"border: 1px solid white;\n"
"border-radius: 5px;\n"
"background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.exp2_ele1y_lineEdit = QLineEdit(self.page_4)
        self.exp2_ele1y_lineEdit.setObjectName(u"exp2_ele1y_lineEdit")
        self.exp2_ele1y_lineEdit.setGeometry(QRect(20, 160, 65, 30))
        self.exp2_ele1y_lineEdit.setFont(font4)
        self.exp2_ele1y_lineEdit.setStyleSheet(u"border: 1px solid white;\n"
"border-radius: 5px;\n"
"background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.exp2_ele2y_lineEdit = QLineEdit(self.page_4)
        self.exp2_ele2y_lineEdit.setObjectName(u"exp2_ele2y_lineEdit")
        self.exp2_ele2y_lineEdit.setGeometry(QRect(90, 160, 65, 30))
        self.exp2_ele2y_lineEdit.setFont(font4)
        self.exp2_ele2y_lineEdit.setStyleSheet(u"border: 1px solid white;\n"
"border-radius: 5px;\n"
"background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.exp2_ele1z_lineEdit = QLineEdit(self.page_4)
        self.exp2_ele1z_lineEdit.setObjectName(u"exp2_ele1z_lineEdit")
        self.exp2_ele1z_lineEdit.setGeometry(QRect(20, 210, 65, 30))
        self.exp2_ele1z_lineEdit.setFont(font4)
        self.exp2_ele1z_lineEdit.setStyleSheet(u"border: 1px solid white;\n"
"border-radius: 5px;\n"
"background-color: rgb(255, 255, 255);\n"
"color: rgb(0, 0, 0);")
        self.exp2_ele2z_lineEdit = QLineEdit(self.page_4)
        self.exp2_ele2z_lineEdit.setObjectName(u"exp2_ele2z_lineEdit")
        self.exp2_ele2z_lineEdit.setGeometry(QRect(90, 210, 65, 30))
        self.exp2_ele2z_lineEdit.setFont(font4)
...
"color: rgb(0, 0, 0);")
        ...
        self.line_6.setGeometry(QRect(5, 10, 5, 281))
        self.line_6.setStyleSheet(u"color: rgb(116, 192, 252);")
        ...
        self.rel_tem_lineEdit.setGeometry(QRect(20, 350, 135, 30))
        self.rel_tem_lineEdit.setFont(font4)
...
"color: rgb(0, 0, 0);")
        ...
        self.label_3.setGeometry(QRect(30, 300, 121, 21))
...
"")
        ...
        self.label_21.setGeometry(QRect(160, 357, 61, 16))
        font6 = QFont()
...
"border-right-color: rgb(233, 236, 239);")
        ...
        self.label_22.setGeometry(QRect(129, 355, 20, 20))
        font7 = QFont()
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_23.setGeometry(QRect(225, 347, 40, 35))
...
"border-color: rgb(233, 236, 239);")
        ...
        self.rel_sys_comboBox.setGeometry(QRect(20, 400, 135, 30))
...
"border-color: rgb(233, 236, 239);")
        ...
        self.label_26.setGeometry(QRect(65, 320, 50, 30))
        ...
        self.rel_tim_lineEdiT.setGeometry(QRect(20, 450, 135, 30))
        self.rel_tim_lineEdiT.setFont(font4)
...
"color: rgb(0, 0, 0);")
        ...
        self.label_27.setGeometry(QRect(130, 454, 20, 20))
...
"border-color: rgb(255, 255, 255);")
        ...
        self.label_28.setGeometry(QRect(160, 457, 61, 16))
        ...
        self.label_29.setGeometry(QRect(225, 450, 30, 29))
...
"border-color: rgb(233, 236, 239);")
        ...
        self.label_30.setGeometry(QRect(50, 490, 81, 30))
...
"border-color: rgb(233, 236, 239);")
        ...
        self.label_31.setGeometry(QRect(160, 526, 50, 15))
        ...
        self.Them_lineEdit.setGeometry(QRect(20, 520, 135, 30))
        self.Them_lineEdit.setFont(font4)
...
"color: rgb(0, 0, 0);")
        ...
        self.label_32.setGeometry(QRect(103, 524, 49, 20))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_33.setGeometry(QRect(225, 517, 30, 30))
...
"border-color: rgb(233, 236, 239);")
        ...
        self.label_35.setGeometry(QRect(220, 566, 40, 35))
...
"border-color: rgb(233, 236, 239);")
        ...
        self.Them_tim_lineEdit.setGeometry(QRect(20, 620, 135, 30))
        self.Them_tim_lineEdit.setFont(font4)
...
"color: rgb(0, 0, 0);")
        ...
        self.label_36.setGeometry(QRect(130, 626, 20, 20))
...
"color: rgb(0\uff0c0\uff0c0);")
        ...
        self.label_37.setGeometry(QRect(160, 627, 61, 16))
        ...
        self.label_38.setGeometry(QRect(225, 620, 30, 29))
...
"border-color: rgb(233, 236, 239);")
        ...
        self.defect_lineEdit.setGeometry(QRect(20, 720, 135, 30))
        self.defect_lineEdit.setFont(font4)
...
"color: rgb(0, 0, 0);")
        ...
        self.line_3.setGeometry(QRect(5, 305, 5, 174))
...
"")
        ...
        self.line_4.setGeometry(QRect(5, 500, 5, 150))
...
"")
        ...
        self.line_5.setGeometry(QRect(5, 670, 5, 80))
...
"")
        ...
        self.rel_tem_lineEdit_2 = QLineEdit(self.widget)
        self.rel_tem_lineEdit_2.setObjectName(u"rel_tem_lineEdit_2")
        self.rel_tem_lineEdit_2.setGeometry(QRect(21, 260, 135, 30))
        self.rel_tem_lineEdit_2.setFont(font4)
...
"color: rgb(0, 0, 0);")
        ...
        self.label_42.setGeometry(QRect(130, 264, 20, 20))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_43.setGeometry(QRect(161, 267, 61, 16))
...
"border-right-color: rgb(233, 236, 239);")
        ...
        self.label_44.setGeometry(QRect(224, 260, 40, 35))
...
"border: 1px solid rgb(248, 249, 250);")
        ...
        self.painting_zoom = QHBoxLayout()
        self.painting_zoom.setSpacing(0)
        self.painting_zoom.setObjectName(u"painting_zoom")

        self.horizontalLayout_15.addLayout(self.painting_zoom)
...
"border-bottom-color: rgb(0, 0, 0);")
        ...
        self.exp1_ele1_mass_lineEdit_2.setFont(font4)
...
"border-bottom-color: rgb(0, 0, 0);")
        ...
        self.exp1_ele1_num_lineEdit_2.setFont(font4)
...
"color: rgb(0, 0, 0);")
        ...
        self.exp_res_lineEdit_2.setFont(font4)
...
"border-bottom-color: rgb(0, 0, 0);")
        ...
        self.exp2_ele1_mass_lineEdit_2.setFont(font4)
...
"border-bottom-color: rgb(0, 0, 0);")
        ...
        self.exp2_ele2_mass_lineEdit_2.setFont(font4)
...
"border-bottom-color: rgb(0, 0, 0);")
        ...
        self.exp2_ele1_num_lineEdit_2.setFont(font4)
...
"border-bottom-color: rgb(0, 0, 0);")
        ...
        self.exp2_ele2_num_lineEdit_2.setFont(font4)
...
"border-bottom-color: rgb(0, 0, 0);")
        ...
        self.exp2_reslineEdit_2.setFont(font4)
...
"background-color: rgb(186, 200, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_21.setText(QCoreApplication.translate("Form", u"\u8bbe\u5b9a\u6e29\u5ea6", None))
        ...
        self.label_42.setText(QCoreApplication.translate("Form", u"K", None))
        self.label_43.setText(QCoreApplication.translate("Form", u"\u521d\u59cb\u6e29\u5ea6", None))
        ...
        self.label_75.setText(QCoreApplication.translate("Form", u"\u754c\u9762\u70ed\u5bfc", None))
        self.exp2_reslineEdit_2.setText("")
        self.label_76.setText(QCoreApplication.translate("Form", u"MW*K-1*m-2", None))
